...
export const SET_RECIPES_ERROR = "recipes/error";
...
export const SET_RECIPE_DETAIL_LOADING = "recipeDetail/loading";
...
export const SET_FEEDS_ERROR = "feeds/error";
export const SET_FEEDS_LOADING = "feeds/loading";
