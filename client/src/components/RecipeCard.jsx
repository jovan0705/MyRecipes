...
const RecipeCard = () => {
    return (
        <>
            <div className="w-auto h-auto border shadow-md flex gap-2 rounded-md text-gray-400 hover:shadow-xl duration-200 ease-in group">
                ...
                <div className="w-1/2 py-2 flex flex-col justify-between">
                    ...
                    <div className="">
                        <p className="text-xs">Posted by <span className="font-bold">Jane Doe</span></p>
                    </div>
                    <div className='flex flex-row-reverse gap-3 py-2 px-5'>
                        <button className='text-xl hover:text-yellow-600'><IoBookmarkOutline/></button>
                        <button className='text-xl hover:text-yellow-600'><IoHeartOutline/></button>
                    </div>
                </div>
            </div>
        </>
